...
for env in envs:     
    ...
    #INK
    env_vars_raw = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_WPPGEN2_SCHEDULED_RAW_{env_for_deployment.upper()}"}
    ...
    env_vars_stdraw = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_WPPGEN2_SCHEDULED_STDRAW_{env_for_deployment.upper()}"}
    ...
    env_vars_stdraw_old = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_WPPGEN2_SCHEDULED_STDRAW_{env_for_deployment.upper()}_OLD"}
    ...
    env_vars_rs = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_WPPGEN2_SCHEDULED_REDSHIFT_{env_for_deployment.upper()}"}
    ...
    env_vars_lake = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_WPPGEN2_SCHEDULED_STDRAW_DELTA_LAKE_{env_for_deployment.upper()}"}
    ...
    #LASER
    laser_env_vars_stdraw = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_WPPGEN2_SCHEDULED_LASER_STDRAW_{env_for_deployment.upper()}"}
    ...
    raw_task_dict["run_op"]>>laser_stdraw_task_dict["branch_op"]
    raw_task_dict["skipped_op"]>>laser_stdraw_task_dict["branch_op"]

    laser_env_vars_stdraw_old = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_WPPGEN2_SCHEDULED_LASER_STDRAW_{env_for_deployment.upper()}_OLD"}
    ...
    raw_task_dict["run_op"]>>laser_stdraw_task_dict_old["branch_op"]
    raw_task_dict["skipped_op"]>>laser_stdraw_task_dict_old["branch_op"]
    
    laser_env_vars_rs = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_WPPGEN2_SCHEDULED_LASER_REDSHIFT_{env_for_deployment.upper()}"}
    ...
    laser_env_vars_lake = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_WPPGEN2_SCHEDULED_LASER_STDRAW_DELTA_LAKE_{env_for_deployment.upper()}"}
    ...
    env_vars_ocv = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_WPPGEN2_SCHEDULED_OCV_{env_for_deployment.upper()}"}
