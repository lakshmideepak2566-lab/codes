...
source_id = "WPPGEN2_SCHEDULED-XREF"
...
for env in envs:     
    ...
    #INK
    env_vars_raw = {**env_vars, "DATABRICKS_DEPLOYMENT_NAME" : f"CUMULUS_WPPGEN2_SCHEDULED_STDRAW_XREF_HARVEST_WEEKLY_{env_for_deployment.upper()}"}
